...
function Equipments() {
  ...
  const [urlDrone, setUrlDrone] = useState('')
  ...
  function handleChange(event) {
    setCurrModels(Drones.filter(e => e.id === parseInt(event.target.value))[0].models)
  }
          ...
          <fieldset className="equipmentformfieldset">
            <div className="equipmentinput-full-container">
              ...
              <select
                ...
                id="brandequipment"
                name="brand"
                className="equipment-input-brand-select"
          ...
          <fieldset className="equipmentformfieldset">
            <div className="equipmentinput-full-container">
              ...
              <select
                ...
                id="modelequipment"
                name="model"
                className="equipment-input-model-select"
                ref={register({
          ...
          <fieldset className="equipmentformfieldset">
            <div className="equipmentinput-full-container">
                ...
                <input
                  ...
                  name='insurance'
                  type='text'
                  className="equipment-input-title"
                  ref={register({
                    required: { value:true, message: 'El campo poliza de seguro es requerido' }
                  })}
                />
            </div>
            <div className="error-input-container-equipment">
